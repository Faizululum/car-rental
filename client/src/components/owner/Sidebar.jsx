  ...
  return (
    <div className="relative min-h-screen md:flex flex-col items-center pt-8 max-w-14 md:max-w-60 w-full border-r border-borderColor text-sm">
      <div className="group relative">
        <label htmlFor="image">
          <img src={image ? URL.createObjectURL(image) : user?.image || "https://unsplash.com/photos/running-black-porsche-sedan-3ZUsNJhi_Ik"} alt="" className="w-full h-full object-cover rounded-lg" />
