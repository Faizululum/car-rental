...
const Cars = () => {
  ...
  const applyFilter = async () => {
    ...
    const filtered = cars.slice().filter((car) => {
      return car.brand.toLowerCase().includes(input.toLowerCase()) || car.model.toLowerCase().includes(input.toLowerCase()) || car.transmission.toLowerCase().includes(input.toLowerCase());
    });
  ...
  return (
    <div>
      <div className="flex flex-col items-center py-20 bg-light mx-md:px-4">
        <Title title="Available Cars" subTitle="Browse our collection of premium available cars for your next vacation." />
