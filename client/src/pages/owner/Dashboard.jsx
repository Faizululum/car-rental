...
const Dashboard = () => {
  ...
  return (
    <div className="px-4 pt-10 md:px-10 flex-1">
      <Title title="Admin Dashboard" subTitle="Monitor overall performance including total cars, total bookings, pending bookings, and completed bookings" />
      ...
      <div className="flex flex-wrap items-start gap-6 mb-8 w-full">
        ...
        <div className="p-4 md:p-6 border border-borderColor rounded-md max-w-lg w-full">
          ...
          <p className="text-gray-500">Latest bookings made by customers</p>
          {data.recentBookings.map((booking, index)=>(
            <div key={index} className="flex items-center justify-between mt-4">
              ...
              <div className="flex items-center gap-2 font-medium">
                <p className="text-sm tegr-gray-500">{currency}{booking.price}</p>
        ...
        <div className="p-4 md:p-6 border border-borderColor rounded-md w-full md:max-w-xs">
          ...
          <p className="text-gray-500">Revenue generated in the last month</p>
