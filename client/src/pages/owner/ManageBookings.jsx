...
const ManageBookings = () => {
  ...
  return (
    <div className="px-4 pt-10 md:px-10 w-full">
      <Title title="Manage Bookings" subTitle="Track all customer bookings, approve or reject them, and manage booking statuses." />
        ...
        <table className="w-full border-collapse text-left text-sm text-gray-600">
          ...
          <tbody>
            {bookings.map((booking, index) => (
              <tr key={index} className="border-t border-borderColor hover:bg-gray-50 text-gray-500">
                ...
                <td className="p-3 max-md:hidden">
                  <span className="px-3 bg-gray-100 py-1 rounded-full text-xs">
                    offline
                  </span>
                </td>
                <td className="p-3">
